...
<html> 
    ...
    <head>
        ...
        <!-- {!! HTML::style('https://cvmkr.com/public/?css=Member,ui,cleditor') !!}
                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
							...
							<li class="has_sub">
                                <a href="cv" class="waves-effect active"><i class="ti-home"></i> <span> Accueil </span> </a>
                            </li>
                            <li class="has_sub">
                                <a href="create" class="waves-effect active"><i class="ti-pencil-alt"></i><span> Nouveau cv </span> </a>
                            </li>

                            <li class="has_sub">
                                <a href="show" class="waves-effect active"><i class="ti-menu-alt"></i> <span> Mes cvs</span> </a>
                            </li>
                        </ul>
